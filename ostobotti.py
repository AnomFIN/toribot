#!/usr/bin/env python3
"""
Tori Ostobotti - Complete working project
...
class OpenAIValuator:
    ...
    def valuate_item(self, item):
        ...
        try:
            ...
            # Prepare prompt
            prompt = f"""Analysoi tämä ostoilmoitus Tori.fi palvelusta ja anna lyhyt arvio suomeksi:
...
Vastaa vain suomeksi, ole ytimekäs."""
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "Olet hyödyllinen avustaja joka arvioi ostoilmoituksia suomeksi. Anna realistisia hinta-arvioita euroina ja markkinatilanne-analyysi."},
...
def index():
    """Serve main GUI"""
    return send_from_directory('.', 'ostobotti_gui.html')
