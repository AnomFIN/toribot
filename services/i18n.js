...
const i18n = {
  ...
  translations: {
      ...
      // Logs
      'logs.title': 'Lokit',
      'logs.description': 'Näytä botin aktiviteettilokit reaaliajassa',
      ...
      'logs.emptyDesc': 'Reaaliaikaiset lokit näkyvät tässä, kun bot on aktiivinen',
      'logs.realtime': 'Reaaliaikaiset lokit',
      'logs.autoScroll': 'Automaattinen vieritys',
      ...
      'toast.themeChangedToDark': 'Teema vaihdettu tumma-tilaan',
      'toast.themeChangedToLight': 'Teema vaihdettu valoisa-tilaan',
    },
    ...
    en: {
      ...
      // Logs
      'logs.title': 'Logs',
      'logs.description': 'View bot activity logs in real-time',
      ...
      'logs.empty': 'No logs',
      'logs.emptyDesc': 'Real-time logs will appear here when the bot is active',
      'logs.realtime': 'Real-time Logs',
